...
sed 's,$AZ_BATCHAI_INPUT_DATA,'$AZ_BATCHAI_INPUT_DATA',g' $AZ_BATCHAI_INPUT_SAMPLE/lenet_train_test.prototxt.template > $AZ_BATCHAI_INPUT_SAMPLE/lenet_train_test.prototxt
