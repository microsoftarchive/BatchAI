...
flags.DEFINE_string("checkpoint_dir", "",
                    "Directory for storing model checkpoint output")
flags.DEFINE_string("log_dir", "",
                    "Directory for storing tensorboard log file")
...
def main(unused_argv):
  ...
  with tf.device(
    ...
    checkpoint_basename = os.path.join(FLAGS.checkpoint_dir, 'model.ckpt')
